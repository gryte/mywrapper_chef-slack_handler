...
task bootstrap_test: [:upload] do
  sh 'knife bootstrap 192.168.1.234 -N testserver -r mywrapper_chef-slack_handler --sudo --ssh-user test --ssh-password test --use-sudo-password --bootstrap-version 14.4.56'
end
